...
export const ACCOUNT_ERROR = {
  ...
  ACCOUNT_PASSWORD_MISMATCH: 'ACCOUNT_PASSWORD_MISMATCH', // [KEPT:业务保留]
  ACCOUNT_PASSWORD_POLICY_VIOLATION: 'ACCOUNT_PASSWORD_POLICY_VIOLATION', // [KEPT:业务保留]
} as const;
...
export const BLOG_ERROR = {
  ...
  UNAUTHORIZED: 'BLOG_UNAUTHORIZED',
  INVALID_PARAMS: 'BLOG_INVALID_PARAMS',
  DUPLICATE_CATEGORY: 'BLOG_DUPLICATE_CATEGORY',
  DUPLICATE_TAG: 'BLOG_DUPLICATE_TAG',
  ADMIN_PASSWORD_CHANGE_FAILED: 'BLOG_ADMIN_PASSWORD_CHANGE_FAILED',
  ENQUEUE_FAILED: 'BLOG_ENQUEUE_FAILED',
} as const; // [KEPT:业务保留]
Object.freeze(BLOG_ERROR); // [KEPT:业务保留]
...
export const MAGIC_ITEM_CRAFT_ERROR = {
  ...
  UNAUTHORIZED: 'MAGIC_ITEM_CRAFT_UNAUTHORIZED',
  TASK_ALREADY_COMPLETED: 'MAGIC_ITEM_CRAFT_TASK_ALREADY_COMPLETED',
...
Object.freeze(MAGIC_ITEM_CRAFT_ERROR); // [KEPT:业务保留]
...
export type BlogErrorCode = (typeof BLOG_ERROR)[keyof typeof BLOG_ERROR]; // [KEPT:业务保留]
export type MagicItemCraftErrorCode =
  (typeof MAGIC_ITEM_CRAFT_ERROR)[keyof typeof MAGIC_ITEM_CRAFT_ERROR]; // [KEPT:业务保留]
...
export type DomainErrorCode =
  ...
  | PaginationErrorCode
  | BlogErrorCode // [KEPT:业务保留]
  | MagicItemCraftErrorCode; // [KEPT:业务保留]
