...
export const ACCOUNT_ERROR = {
  ...
  ACCOUNT_SUSPEND_FAILED: 'ACCOUNT_SUSPEND_FAILED',
} as const;
...
// 队列生产相关错误码（infrastructure producer gateway 抛出，由 usecase 上报）
export const QUEUE_ERROR = {
  JOB_ID_CONFLICTS_WITH_DEDUP_KEY: 'QUEUE_JOB_ID_CONFLICTS_WITH_DEDUP_KEY',
  DEDUP_JOB_NAME_CONFLICT: 'QUEUE_DEDUP_JOB_NAME_CONFLICT',
  MISSING_EXISTING_PAYLOAD_TRACE_ID: 'QUEUE_MISSING_EXISTING_PAYLOAD_TRACE_ID',
  JOB_ID_REQUIRED: 'QUEUE_JOB_ID_REQUIRED',
} as const;
Object.freeze(QUEUE_ERROR);
...
export const BLOG_ERROR = {
  ...
  FRIEND_LINK_NOT_FOUND: 'BLOG_FRIEND_LINK_NOT_FOUND',
  PROFILE_NOT_FOUND: 'BLOG_PROFILE_NOT_FOUND',
  SLUG_ALREADY_EXISTS: 'BLOG_SLUG_ALREADY_EXISTS',
  FILE_UPLOAD_FAILED: 'BLOG_FILE_UPLOAD_FAILED',
  FILE_NOT_FOUND: 'BLOG_FILE_NOT_FOUND',
  FILE_DELETE_FAILED: 'BLOG_FILE_DELETE_FAILED',
  INVALID_PARAMS: 'BLOG_INVALID_PARAMS',
  DUPLICATE_CATEGORY_NAME: 'BLOG_DUPLICATE_CATEGORY_NAME',
  DUPLICATE_TAG_NAME: 'BLOG_DUPLICATE_TAG_NAME',
  DUPLICATE_FRIEND_LINK_NAME: 'BLOG_DUPLICATE_FRIEND_LINK_NAME',
  DUPLICATE_FRIEND_LINK_URL: 'BLOG_DUPLICATE_FRIEND_LINK_URL',
  PASSWORD_CHANGE_FAILED: 'BLOG_PASSWORD_CHANGE_FAILED',
  LIKE_FAILED: 'BLOG_LIKE_FAILED',
  CATEGORY_HAS_POSTS: 'BLOG_CATEGORY_HAS_POSTS',
  CATEGORY_PARENT_INVALID: 'BLOG_CATEGORY_PARENT_INVALID',
  ...
  POST_CREATE_FAILED: 'BLOG_POST_CREATE_FAILED',
  POST_ALREADY_PUBLISHED: 'BLOG_POST_ALREADY_PUBLISHED',
  POST_DELETED: 'BLOG_POST_DELETED',
  POST_ALREADY_RESTORED: 'BLOG_POST_ALREADY_RESTORED',
  POST_NOT_DELETED: 'BLOG_POST_NOT_DELETED',
  POST_SLUG_DUPLICATE: 'BLOG_POST_SLUG_DUPLICATE',
  TAG_HAS_POSTS: 'BLOG_TAG_HAS_POSTS',
