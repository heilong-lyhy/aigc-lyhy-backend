...
@Module({
  providers: [ReferenceProfileCapabilityAnchor, ReferenceProfileListByGroupKeysHandler],
  exports: [ReferenceProfileCapabilityAnchor, ReferenceProfileListByGroupKeysHandler],
})
